...
# Risk of balance when stoploss hits (0.02 = 2%)
RISK=0.02

# Take profit multiplier from stopdistance, target 1 2 and 3
TP_MULTIPLIER=1
TP_MULTIPLIER2=1.5
TP_MULTIPLIER3=2
ENTRY_AFTER_AMEND=1.01 #how much to raise average entry to act as a trailing stoploss and trailing targets

# Creates target 1 and 2 orders
TAKEPROFIT=True 

# Amend stop to profit if True, closes position if False.
REVERSAL_AMEND=True

ATR_STOP_MULTIPLIER=3.5
# The size orders should be when pressing hotkeys, on btc 100 is minimum. (changing this might cause unexpected results.)
ORDERSIZE=100
...
MINIMUM_POS = 100
OVERRIDE_STOCK_ORDER_VALUES = True
SATOSHI_PER_CONTRACT = 10000
MAX_LEVERAGE = 2.5
VALUE_PER = 100000
CHECK_POSITION_LIMITS = True
MIN_POSITION = -20000
MAX_POSITION = 20000
# num contracts to try to have (must always be positive number)
...
WATCHED_FILES = [join('market_maker', 'market_maker.py'),join('market_maker', 'macd_strat.py'),
